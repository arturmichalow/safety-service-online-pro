...
export async function GET(){
 ...
 const extraOrders=await prisma.extraOrder.findMany({include:{company:{include:{assignedUser:{select:{id:true,name:true,email:true}}}}},orderBy:{date:'desc'}});
 ...
 return Response.json({companies,workEntries,extraOrders,users});
}
